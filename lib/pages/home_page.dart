...
class _HomePageState extends State<HomePage> {
  ...
  gettingUserData() async {
    ...
    //getting the list of snapshot in our streambuilder
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "You've not joined any groups,tap on the add icon to create a group or else search from top search buttom ",
            textAlign: TextAlign.center,
          ),
        ],
      ),
